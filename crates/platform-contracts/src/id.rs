...
descriptors! {
    ...
    SandboxJob => ("sjob", "sandbox_job", Public),
    Run => ("run", "run", Public),
    RunValue => ("rval", "run_value", Internal),
    NodeExecution => ("nex", "node_execution", Public),
    ...
    ArtifactGrant => ("agr", "artifact_grant", Internal),
    ...
    OutboxEvent => ("out", "outbox_event", Internal),
