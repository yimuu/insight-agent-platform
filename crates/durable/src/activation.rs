...
fn model_data_transition_key(
    value: Result<TransitionKey, insight_engine::ModelError>,
...
impl LeaseGrantAuthority {
    ...
    #[allow(dead_code)]
    pub(crate) fn mint_proof(&self) -> insight_engine::LeaseGrantProof {
...
impl RetryScheduleAuthority {
    ...
    pub(crate) fn mint_proof(
        &self,
    ) -> Result<insight_engine::RetryScheduleProof, insight_engine::ModelError> {
...
impl CommittedTerminalActivationAuthority {
    ...
    pub fn bind(
        self,
        proof: insight_engine::TerminalActivationProof,
        ...
        let result_matches = match (&self.result, proof.result()) {
            (
                ...
                insight_engine::TerminalActivationResult::Succeeded {
            ...
            (
                ...
                insight_engine::TerminalActivationResult::Failed {
            ...
            (
                ...
                insight_engine::TerminalActivationResult::Cancelled,
            )
            | (
                CommittedTerminalActivationResult::TimedOut,
                insight_engine::TerminalActivationResult::TimedOut,
            ) => true,
            _ => false,
        };
...
pub struct CommittedTerminalActivationProof {
    ...
    aggregate_proof: insight_engine::TerminalActivationProof,
}
...
impl CommittedTerminalActivationProof {
    ...
    pub fn aggregate_proof(&self) -> &insight_engine::TerminalActivationProof {
...
pub struct WaitResolutionAuthority {
    ...
    subject: insight_engine::WaitResolutionSubject,
...
impl WaitResolutionAuthority {
    ...
    pub fn subject(&self) -> &insight_engine::WaitResolutionSubject {
        &self.subject
    }
    ...
    pub(crate) fn mint_proof(
        &self,
    ) -> Result<insight_engine::WaitResolutionProof, insight_engine::ModelError> {
...
impl TaskEnvelope {
    ...
    pub fn fence(&self) -> Result<LeaseFence, insight_engine::ModelError> {
...
///
/// These functions intentionally keep repository-owned inherent constructors
/// out of the public contract surface.
#[doc(hidden)]
pub mod adapter {
    use super::*;

    pub fn activation_admission_stable_key(command: &ActivationAdmissionCommand) -> &str {
        command.stable_activation_key()
    }

    pub fn heartbeat_transition_key(
        command: &HeartbeatAttemptCommand,
    ) -> Result<TransitionKey, RepositoryError> {
        command.transition_key()
    }

    pub const fn activation_timer_kind_str(kind: ActivationTimerKind) -> &'static str {
        kind.as_str()
    }

    pub fn activation_commit_receipt(
        event_seq: u64,
        event_id: String,
        activation_projection_version: u64,
        scope_projection_version: Option<u64>,
    ...
    pub fn retry_schedule_authority(
        run_id: RunId,
        activation_id: ActivationId,
        previous_fence: LeaseFence,
        timer_id: TimerId,
        retry_at: DateTime<Utc>,
        remaining_attempt_budget: u32,
    ) -> RetryScheduleAuthority {
        RetryScheduleAuthority::new(
            run_id,
            activation_id,
            previous_fence,
            timer_id,
    ...
    pub fn committed_terminal_activation_authority(
        receipt: ActivationCommitReceipt,
        run_id: RunId,
        scope_instance_id: ScopeInstanceId,
        activation_id: ActivationId,
        result: CommittedTerminalActivationResult,
    ) -> Result<CommittedTerminalActivationAuthority, RepositoryError> {
        CommittedTerminalActivationAuthority::new(
            receipt,
            run_id,
            scope_instance_id,
            activation_id,
    ...
    pub fn signal_receipt(
        ...
        SignalReceipt::new(signal_id, payload_id, content_hash)
    }

    #[allow(clippy::too_many_arguments)]
    pub fn wait_resolution_authority(
        receipt: ActivationCommitReceipt,
        run_id: RunId,
        scope_instance_id: ScopeInstanceId,
        activation_id: ActivationId,
    ...
    pub fn execution_kind_fields(kind: &ExecutionKind) -> (&'static str, &'static str, u32) {
        super::execution_kind_fields(kind)
    }

    pub const fn effect_idempotency_str(value: EffectIdempotency) -> &'static str {
        super::effect_idempotency_str(value)
    }

    pub fn parse_effect_idempotency(value: &str) -> Result<EffectIdempotency, RepositoryError> {
        super::parse_effect_idempotency(value)
    }

    pub const fn effect_evidence_str(value: EffectEvidence) -> &'static str {
        super::effect_evidence_str(value)
    }

    pub fn parse_effect_evidence(value: &str) -> Result<EffectEvidence, RepositoryError> {
        super::parse_effect_evidence(value)
    }

    pub fn parse_activation_lifecycle(value: &str) -> Result<ActivationLifecycle, RepositoryError> {
        super::parse_activation_lifecycle(value)
    }
}
...
mod tests {
    ...
    fn wait_authority_mints_an_unfenced_committed_output_proof() {
        ...
        let authority = WaitResolutionAuthority::new(
            ...
            activation_id(),
            registration.clone(),
            insight_engine::WaitResolutionSubject::Signal(signal_id.clone()),
            winning.clone(),
            output.clone(),
        )
        .unwrap();
        ...
        assert_eq!(
            proof.subject(),
            &insight_engine::WaitResolutionSubject::Signal(signal_id)
        );
