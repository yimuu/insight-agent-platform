...
impl DslPath {
    ...
    fn from_serde_path(path: &str) -> Option<Self> {
        if path == "." {
...
impl SourceSpan {
    ...
    fn range(source: &str, byte_start: usize, byte_end: usize) -> Self {
    ...
    fn point(source: &str, byte_index: usize) -> Self {
...
/// Workspace-internal constructors needed by parser adapters.
#[doc(hidden)]
pub mod adapter {
    use super::{DslPath, SourceSpan};

    pub fn dsl_path_from_serde_path(path: &str) -> Option<DslPath> {
        DslPath::from_serde_path(path)
    }

    pub fn source_span_document(source: &str) -> SourceSpan {
        SourceSpan::document(source)
    }

    pub fn source_span_range(source: &str, byte_start: usize, byte_end: usize) -> SourceSpan {
        SourceSpan::range(source, byte_start, byte_end)
    }

    pub fn source_span_point(source: &str, byte_index: usize) -> SourceSpan {
        SourceSpan::point(source, byte_index)
    }
}
