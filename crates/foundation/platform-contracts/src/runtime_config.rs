...
pub const OUTBOX_WORKER_WORKLOAD_IDENTITY: &str =
    "spiffe://insight.platform/workload/outbox-worker";
...
pub fn builtin_echo_module_digest() -> Sha256Digest {
    builtin_capability_digest("builtin-echo-module")
}
