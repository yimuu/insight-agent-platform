...
string_enum! {
    pub enum JobKind, "job kind" {
        ...
        McpOAuthPkceCleanup => "mcp_oauth_pkce_cleanup",
...
string_enum! {
    pub enum Permission, "permission" {
        ...
        HistoryHoldManage => "history.hold.manage",
        McpCleanupRecover => "mcp.cleanup.recover",
...
string_enum! {
    pub enum ApiProblemCode, "API problem code" {
        ...
        TaskFormUnavailable => "task_form_unavailable",
        ...
        RunEventHistoryGap => "run_event_history_gap",
        RecompileRequired => "recompile_required",
