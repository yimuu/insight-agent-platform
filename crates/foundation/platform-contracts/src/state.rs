...
closed_state_machine! {
    pub enum ContextQueryState, "context_query" {
        Created => "created" => [AwaitingAuthorization, Ready, Failed, Cancelled, TimedOut],
...
closed_state_machine! {
    pub enum ModelTurnState, "model_turn" {
        Created => "created" => [AwaitingBudget, Ready, Failed, Cancelled, TimedOut],
        AwaitingBudget => "awaiting_budget" => [Ready, Failed, Cancelled, TimedOut],
        Ready => "ready" => [InFlight, Cancelling, Cancelled, TimedOut],
