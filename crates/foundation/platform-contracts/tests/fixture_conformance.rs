...
fn repository_root() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR"))
        ...
        .expect("workspace contract root exists")
        .to_owned()
}
...
#[test]
fn model_turn_current_state_machine_has_exact_control_edges() {
    let machine = insight_platform_contracts::state::ModelTurnState::descriptor();
    let mut expected = vec![
        ["created", "awaiting_budget"],
        ["created", "ready"],
        ["created", "failed"],
        ["created", "cancelled"],
        ["created", "timed_out"],
        ["awaiting_budget", "ready"],
        ["awaiting_budget", "failed"],
        ["awaiting_budget", "cancelled"],
        ["awaiting_budget", "timed_out"],
        ["ready", "in_flight"],
        ["ready", "cancelling"],
        ["ready", "cancelled"],
        ["ready", "timed_out"],
...
#[test]
fn context_query_current_state_machine_has_exact_control_edges() {
    let machine = insight_platform_contracts::state::ContextQueryState::descriptor();
    let mut expected = vec![
        ...
        ["awaiting_authorization", "timed_out"],
        ["ready", "in_flight"],
        ["ready", "cancelled"],
        ["ready", "timed_out"],
        ["in_flight", "succeeded"],
