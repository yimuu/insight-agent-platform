...
pub struct StartedOrchestrationJob {
    claimed: insight_platform_orchestrator::store::ClaimedOrchestrationJob,
    started: JobRecord,
}
...
impl StartedOrchestrationJob {
    ...
    pub fn claimed(&self) -> &insight_platform_orchestrator::store::ClaimedOrchestrationJob {
        &self.claimed
    }
    ...
    fn claimed() -> ClaimedOrchestrationJob {
        ...
        ClaimedOrchestrationJob {
            job: JobRecord {
                ...
                payload: crate::test_orchestration_payload(id(ResourceKind::NodeExecution, "6603")),
                started_at: None,
                terminal_at: None,
                created_at: now,
                updated_at: now,
