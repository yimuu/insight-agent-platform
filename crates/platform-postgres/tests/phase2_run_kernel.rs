...
fn run_admission_and_controls_are_atomic_exact_and_first_winner() {
    ...
    let mutation_ids = |receipt_suffix: &str,
        ...
        DeferOrchestrationChildMutationIds {
            ...
            root_run_outbox_id: platform_id("out", event_suffixes[0]),
            parent_run_event_id: platform_id("evt", event_suffixes[1]),
            parent_run_outbox_id: platform_id("out", event_suffixes[1]),
            parent_node_event_id: platform_id("evt", event_suffixes[2]),
            parent_node_outbox_id: platform_id("out", event_suffixes[2]),
            parent_job_event_id: platform_id("evt", event_suffixes[3]),
            parent_job_outbox_id: platform_id("out", event_suffixes[3]),
            child_link_event_id: platform_id("evt", event_suffixes[4]),
            child_link_outbox_id: platform_id("out", event_suffixes[4]),
            child_run_event_id: platform_id("evt", event_suffixes[5]),
            child_run_outbox_id: platform_id("out", event_suffixes[5]),
            child_job_event_id: platform_id("evt", event_suffixes[6]),
            child_job_outbox_id: platform_id("out", event_suffixes[6]),
        }
    };
    ...
    let quorum_join_step = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "92b5"),
            node_event_id: fixture_platform_id("evt", "92b6"),
            node_outbox_id: fixture_platform_id("out", "92b6"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                node_outbox_id: fixture_platform_id("out", "92ba"),
                job_event_id: fixture_platform_id("evt", "92bb"),
                job_outbox_id: fixture_platform_id("out", "92bb"),
            }],
            pending_nodes: Vec::new(),
            structural_exit: None,
            pending_wake: None,
    ...
    let cancel_join_step = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "94c5"),
            node_event_id: fixture_platform_id("evt", "94c6"),
            node_outbox_id: fixture_platform_id("out", "94c6"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                node_outbox_id: fixture_platform_id("out", "94ca"),
                job_event_id: fixture_platform_id("evt", "94cb"),
                job_outbox_id: fixture_platform_id("out", "94cb"),
            }],
            pending_nodes: Vec::new(),
            structural_exit: None,
            pending_wake: None,
    ...
    let fail_join = FailOrchestrationJob {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "95c5"),
            node_event_id: fixture_platform_id("evt", "95c6"),
            node_outbox_id: fixture_platform_id("out", "95c6"),
            job_event_id: fixture_platform_id("evt", "95c7"),
            job_outbox_id: fixture_platform_id("out", "95c7"),
            activations: Vec::new(),
            pending_nodes: Vec::new(),
            structural_exit: Some(ControllerStructuralExitSlot {
                scope_closing_event_id: fixture_platform_id("evt", "95c8"),
                scope_closing_outbox_id: fixture_platform_id("out", "95c8"),
                scope_terminal_event_id: fixture_platform_id("evt", "95c9"),
                scope_terminal_outbox_id: fixture_platform_id("out", "95c9"),
            }),
            pending_wake: None,
            remainder_cancellations: Vec::new(),
        },
    ...
    let enter_boundary = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9625"),
            node_event_id: fixture_platform_id("evt", "9626"),
            node_outbox_id: fixture_platform_id("out", "9626"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                node_outbox_id: fixture_platform_id("out", "962a"),
                job_event_id: fixture_platform_id("evt", "962b"),
                job_outbox_id: fixture_platform_id("out", "962b"),
            }],
            pending_nodes: Vec::new(),
            structural_exit: None,
            pending_wake: None,
    ...
    let route_boundary_failure = FailOrchestrationJob {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9645"),
            node_event_id: fixture_platform_id("evt", "9646"),
            node_outbox_id: fixture_platform_id("out", "9646"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                node_outbox_id: fixture_platform_id("out", "964a"),
                job_event_id: fixture_platform_id("evt", "964b"),
                job_outbox_id: fixture_platform_id("out", "964b"),
            }],
            pending_nodes: Vec::new(),
            structural_exit: None,
            pending_wake: None,
    ...
    let fail_boundary_handler = FailOrchestrationJob {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9665"),
            node_event_id: fixture_platform_id("evt", "9666"),
            node_outbox_id: fixture_platform_id("out", "9666"),
            job_event_id: fixture_platform_id("evt", "9667"),
            job_outbox_id: fixture_platform_id("out", "9667"),
            activations: Vec::new(),
            pending_nodes: Vec::new(),
            structural_exit: Some(ControllerStructuralExitSlot {
                scope_closing_event_id: fixture_platform_id("evt", "9668"),
                scope_closing_outbox_id: fixture_platform_id("out", "9668"),
                scope_terminal_event_id: fixture_platform_id("evt", "9669"),
                scope_terminal_outbox_id: fixture_platform_id("out", "9669"),
            }),
            pending_wake: None,
            remainder_cancellations: Vec::new(),
        },
    ...
    let open_loop_iteration = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9725"),
            node_event_id: fixture_platform_id("evt", "9726"),
            node_outbox_id: fixture_platform_id("out", "9726"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                scope: Some(ControllerScopeSlot {
                    ...
                    scope_outbox_id: fixture_platform_id("out", "972d"),
                }),
                node_event_id: fixture_platform_id("evt", "972b"),
                node_outbox_id: fixture_platform_id("out", "972b"),
    ...
    let exit_loop = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9765"),
            node_event_id: fixture_platform_id("evt", "9766"),
            node_outbox_id: fixture_platform_id("out", "9766"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                node_outbox_id: fixture_platform_id("out", "976a"),
                job_event_id: fixture_platform_id("evt", "976b"),
                job_outbox_id: fixture_platform_id("out", "976b"),
            }],
            pending_nodes: Vec::new(),
            structural_exit: None,
            pending_wake: None,
    ...
    let open_first_map_batch = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9825"),
            node_event_id: fixture_platform_id("evt", "9826"),
            node_outbox_id: fixture_platform_id("out", "9826"),
            ...
            activations: vec![
                ControllerActivationSlot {
                    ...
                    scope: Some(ControllerScopeSlot {
                        ...
                        scope_outbox_id: fixture_platform_id("out", "982d"),
                    }),
                    node_event_id: fixture_platform_id("evt", "982b"),
                    node_outbox_id: fixture_platform_id("out", "982b"),
                ...
                ControllerActivationSlot {
                    ...
                    scope: Some(ControllerScopeSlot {
                        ...
                        scope_outbox_id: fixture_platform_id("out", "983d"),
                    }),
                    node_event_id: fixture_platform_id("evt", "983b"),
                    node_outbox_id: fixture_platform_id("out", "983b"),
                    job_event_id: fixture_platform_id("evt", "983c"),
                    job_outbox_id: fixture_platform_id("out", "983c"),
                },
            ],
            pending_nodes: vec![ControllerPendingNodeSlot {
            ...
            pending_wake: Some(ControllerPendingWakeSlot {
                ...
                node_outbox_id: fixture_platform_id("out", "9842"),
                job_event_id: fixture_platform_id("evt", "9843"),
                job_outbox_id: fixture_platform_id("out", "9843"),
            }),
            remainder_cancellations: Vec::new(),
        },
    };
    ...
    let open_final_map_batch = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9855"),
            node_event_id: fixture_platform_id("evt", "9856"),
            node_outbox_id: fixture_platform_id("out", "9856"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                scope: Some(ControllerScopeSlot {
                    ...
                    scope_outbox_id: fixture_platform_id("out", "985d"),
                }),
                node_event_id: fixture_platform_id("evt", "985b"),
                node_outbox_id: fixture_platform_id("out", "985b"),
    ...
    ) in map_item_fixtures.into_iter().enumerate()
    {
        ...
        let settle_mutations = ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", settle_events[0]),
            node_event_id: fixture_platform_id("evt", settle_events[1]),
            node_outbox_id: fixture_platform_id("out", settle_events[1]),
            job_event_id: fixture_platform_id("evt", settle_events[2]),
            job_outbox_id: fixture_platform_id("out", settle_events[2]),
            activations: Vec::new(),
            pending_nodes: Vec::new(),
            structural_exit: Some(ControllerStructuralExitSlot {
                scope_closing_event_id: fixture_platform_id("evt", scope_events[0]),
                scope_closing_outbox_id: fixture_platform_id("out", scope_events[0]),
                scope_terminal_event_id: fixture_platform_id("evt", scope_events[1]),
                scope_terminal_outbox_id: fixture_platform_id("out", scope_events[1]),
            }),
            pending_wake: Some(ControllerPendingWakeSlot {
                ...
                node_outbox_id: fixture_platform_id("out", wake_events[0]),
                job_event_id: fixture_platform_id("evt", wake_events[1]),
                job_outbox_id: fixture_platform_id("out", wake_events[1]),
            }),
            remainder_cancellations: Vec::new(),
        };
    ...
    let complete_map = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "98d5"),
            node_event_id: fixture_platform_id("evt", "98d6"),
            node_outbox_id: fixture_platform_id("out", "98d6"),
            ...
            activations: vec![ControllerActivationSlot {
                ...
                node_outbox_id: fixture_platform_id("out", "98da"),
                job_event_id: fixture_platform_id("evt", "98db"),
                job_outbox_id: fixture_platform_id("out", "98db"),
            }],
            pending_nodes: Vec::new(),
            structural_exit: None,
            pending_wake: None,
    ...
    let open_fail_fast_map = ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9916"),
            node_event_id: fixture_platform_id("evt", "9917"),
            node_outbox_id: fixture_platform_id("out", "9917"),
            ...
            activations: vec![
                ControllerActivationSlot {
                    ...
                    scope: Some(ControllerScopeSlot {
                        ...
                        scope_outbox_id: fixture_platform_id("out", "991c"),
                    }),
                    node_event_id: fixture_platform_id("evt", "991d"),
                    node_outbox_id: fixture_platform_id("out", "991d"),
                ...
                ControllerActivationSlot {
                    ...
                    scope: Some(ControllerScopeSlot {
                        ...
                        scope_outbox_id: fixture_platform_id("out", "9922"),
                    }),
                    node_event_id: fixture_platform_id("evt", "9923"),
                    node_outbox_id: fixture_platform_id("out", "9923"),
                    job_event_id: fixture_platform_id("evt", "9924"),
                    job_outbox_id: fixture_platform_id("out", "9924"),
                },
            ],
            pending_nodes: vec![ControllerPendingNodeSlot {
    ...
    let fail_fast_settlement = FailOrchestrationJob {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", "9985"),
            node_event_id: fixture_platform_id("evt", "9986"),
            node_outbox_id: fixture_platform_id("out", "9986"),
            job_event_id: fixture_platform_id("evt", "9987"),
            job_outbox_id: fixture_platform_id("out", "9987"),
            activations: Vec::new(),
            pending_nodes: Vec::new(),
            structural_exit: Some(ControllerStructuralExitSlot {
                scope_closing_event_id: fixture_platform_id("evt", "9988"),
                scope_closing_outbox_id: fixture_platform_id("out", "9988"),
                scope_terminal_event_id: fixture_platform_id("evt", "9989"),
                scope_terminal_outbox_id: fixture_platform_id("out", "9989"),
            }),
            pending_wake: None,
            remainder_cancellations: Vec::new(),
        },
...
fn orchestration_claim_with_ids(
    ...
    ClaimOrchestrationJobs {
        ...
        slots: vec![OrchestrationClaimSlot {
            ...
            run_outbox_id: platform_id("out", event_suffixes[0]),
            node_event_id: platform_id("evt", event_suffixes[1]),
            node_outbox_id: platform_id("out", event_suffixes[1]),
            job_event_id: platform_id("evt", event_suffixes[2]),
            job_outbox_id: platform_id("out", event_suffixes[2]),
        }],
    }
}
...
fn start_claimed_orchestration(
    ...
    StartOrchestrationJob {
        ...
        job_outbox_id: fixture_platform_id("out", job_event_suffix),
        node_event_id: fixture_platform_id("evt", node_event_suffix),
        node_outbox_id: fixture_platform_id("out", node_event_suffix),
    }
}
...
fn parallel_leg_exit_step(
    ...
    ApplyOrchestrationControllerStep {
        ...
        mutations: ControllerStepMutationIds {
            ...
            run_outbox_id: fixture_platform_id("out", source_event_suffixes[0]),
            node_event_id: fixture_platform_id("evt", source_event_suffixes[1]),
            node_outbox_id: fixture_platform_id("out", source_event_suffixes[1]),
            job_event_id: fixture_platform_id("evt", source_event_suffixes[2]),
            job_outbox_id: fixture_platform_id("out", source_event_suffixes[2]),
            activations: Vec::new(),
            pending_nodes: Vec::new(),
            structural_exit: Some(ControllerStructuralExitSlot {
                scope_closing_event_id: fixture_platform_id("evt", scope_event_suffixes[0]),
                scope_closing_outbox_id: fixture_platform_id("out", scope_event_suffixes[0]),
                scope_terminal_event_id: fixture_platform_id("evt", scope_event_suffixes[1]),
                scope_terminal_outbox_id: fixture_platform_id("out", scope_event_suffixes[1]),
            }),
            pending_wake: Some(ControllerPendingWakeSlot {
                ...
                node_outbox_id: fixture_platform_id("out", wake_event_suffixes[0]),
                job_event_id: fixture_platform_id("evt", wake_event_suffixes[1]),
                job_outbox_id: fixture_platform_id("out", wake_event_suffixes[1]),
            }),
            remainder_cancellations: Vec::new(),
        },
    }
...
fn remainder_cancellation_slot(
    ...
    ControllerRemainderCancellationSlot {
        ...
        node_cancelling_outbox_id: fixture_platform_id("out", event_suffixes[0]),
        node_terminal_event_id: fixture_platform_id("evt", event_suffixes[1]),
        node_terminal_outbox_id: fixture_platform_id("out", event_suffixes[1]),
        scope_closing_event_id: fixture_platform_id("evt", event_suffixes[2]),
        scope_closing_outbox_id: fixture_platform_id("out", event_suffixes[2]),
        scope_terminal_event_id: fixture_platform_id("evt", event_suffixes[3]),
        scope_terminal_outbox_id: fixture_platform_id("out", event_suffixes[3]),
        job_terminal_event_id: fixture_platform_id("evt", event_suffixes[4]),
        job_terminal_outbox_id: fixture_platform_id("out", event_suffixes[4]),
    }
}
            ...
            activations: leg_suffixes
                ...
                .map(|suffixes| ControllerActivationSlot {
                    ...
                    scope: Some(ControllerScopeSlot {
                        ...
                        scope_outbox_id: fixture_platform_id("out", suffixes[5]),
                    }),
                    node_event_id: fixture_platform_id("evt", suffixes[3]),
                    node_outbox_id: fixture_platform_id("out", suffixes[3]),
                    job_event_id: fixture_platform_id("evt", suffixes[4]),
                    job_outbox_id: fixture_platform_id("out", suffixes[4]),
                })
                .collect(),
            pending_nodes: vec![ControllerPendingNodeSlot {
...
fn orchestration_convergence(
    ...
    DriveOrchestrationConvergence {
        ...
        slots: vec![OrchestrationConvergenceSlot {
            ...
            node_cancelling_outbox_id: platform_id("out", event_suffixes[5]),
            scope_closing_event_id: platform_id("evt", event_suffixes[2]),
            scope_closing_outbox_id: platform_id("out", event_suffixes[2]),
            scope_terminal_event_id: platform_id("evt", event_suffixes[3]),
            scope_terminal_outbox_id: platform_id("out", event_suffixes[3]),
            job_event_id: platform_id("evt", event_suffixes[4]),
            job_outbox_id: platform_id("out", event_suffixes[4]),
        }],
    }
}
...
fn expired_task_scan(
    ...
    DriveExpiredOrchestrationTasks {
        ...
        slots: vec![ExpiredOrchestrationTaskSlot {
            ...
            task_outbox_id: platform_id("out", event_suffixes[0]),
            run_event_id: platform_id("evt", event_suffixes[1]),
            run_outbox_id: platform_id("out", event_suffixes[1]),
            node_event_id: platform_id("evt", event_suffixes[2]),
            node_outbox_id: platform_id("out", event_suffixes[2]),
            job_event_id: platform_id("evt", event_suffixes[3]),
            job_outbox_id: platform_id("out", event_suffixes[3]),
        }],
    }
}
