//! Canvas authoring contracts for DSL v3.
//!
...
pub const GRAPH_DOCUMENT_INVALID: &str = "DSL_V3_GRAPH_DOCUMENT_INVALID";
pub const GRAPH_PLAN_INVALID: &str = "DSL_V3_GRAPH_PLAN_INVALID";
pub const GRAPH_PLAN_HASH_MISMATCH: &str = "DSL_V3_GRAPH_PLAN_HASH_MISMATCH";
pub const GRAPH_STRUCTURED_COMPILE_FAILED: &str = "DSL_V3_GRAPH_STRUCTURED_COMPILE_FAILED";
pub const GRAPH_IRREDUCIBLE: &str = "DSL_V3_GRAPH_IRREDUCIBLE";
pub const GRAPH_REDUCTION_UNSUPPORTED: &str = "DSL_V3_GRAPH_REDUCTION_UNSUPPORTED";
pub const GRAPH_REDUCTION_MISMATCH: &str = "DSL_V3_GRAPH_REDUCTION_MISMATCH";
pub const GRAPH_EDIT_KIND_MISMATCH: &str = "DSL_V3_GRAPH_EDIT_KIND_MISMATCH";
pub const GRAPH_EDIT_INVALID: &str = "DSL_V3_GRAPH_EDIT_INVALID";
pub const GRAPH_EDIT_CONFLICT: &str = "DSL_V3_GRAPH_EDIT_CONFLICT";
pub const VIEW_DOCUMENT_INVALID: &str = "DSL_V3_VIEW_DOCUMENT_INVALID";
pub const TRACE_OVERLAY_INVALID: &str = "DSL_V3_TRACE_OVERLAY_INVALID";
...
impl GraphAuthorDocument {
    ...
    /// Explicit structured AST -> graph conversion through the existing v3
    ...
    pub fn from_structured_source(
        ...
        graph.structured_reduction = Some(StructuredReductionCertificate {
            compiler_version: V3_COMPILER_VERSION.to_owned(),
            source,
    ...
    pub fn to_structured(&self) -> Result<ReducedStructuredDocument, GraphReductionDiagnostic> {
        ...
        if certificate.compiler_version != V3_COMPILER_VERSION {
