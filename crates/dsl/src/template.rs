//! Restricted, deterministic template profile used by DSL messages and
...
pub const TEMPLATE_INVALID: &str = "DSL_TEMPLATE_INVALID";
pub const TEMPLATE_RENDER_INVALID: &str = "DSL_TEMPLATE_RENDER_INVALID";
pub const TEMPLATE_OUTPUT_TOO_LARGE: &str = "DSL_TEMPLATE_OUTPUT_TOO_LARGE";
...
impl TemplateError {
    fn invalid() -> Self {
        Self {
            ...
            message: "template does not satisfy the restricted DSL profile",
        }
    }
