...
use insight_platform_execution_context::scope_trace;
#[cfg(test)]
use insight_platform_execution_context::ExecutionTraceContext;
...
use insight_platform_rpc_trace::{require_trace_interceptor, trace_context, PropagateTrace};
...
mod tests {
    ...
    use insight_platform_rpc_trace::request_with_trace;
    use rcgen::{
