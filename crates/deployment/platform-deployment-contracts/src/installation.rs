...
/// Public options for the repository's Compose entry point. Secrets are generated by prepare.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct LocalComposeOptionsV1 {
    pub schema_version: u32,
    pub name: String,
    pub http_port: u16,
}
impl LocalComposeOptionsV1 {
    pub fn validate(&self) -> Result<(), InstallationError> {
        if self.schema_version != 1 || !label(&self.name, 63) || self.http_port < 1024 {
...
impl InstallationDatabasePurpose {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::LocalIdentity => "local-identity",
        }
    }
    pub const fn role_names(self) -> &'static [&'static str] {
        match self {
            Self::Runtime => &["insight_runtime_dev"],
            Self::LocalIdentity => &["insight_local_identity_dev"],
