...
use crate::repository::{
    ...
    validate_deployment_closure_exists, PgRepository, RepositoryError,
};
    ...
    pub async fn request_context_dataset_build(
        ...
        sqlx::query(
            ...
            INSERT INTO insight_platform.jobs (
                ...
                $1, $2, 'context_dataset_build', 'context', 'context_dataset', $3, 'ready', $4, $5, $6, 0, $7, $8, $9, $10, (SELECT observed_at FROM job_creation_time), GREATEST($5::timestamptz, (SELECT observed_at FROM job_creation_time)), $11, (SELECT scheduler_partition_id FROM insight_platform.tenants WHERE tenant_id=$1), $12, $13, $14
            )
            "#,
        )
        .bind(command.audit.tenant_id.to_string())
...
async fn insert_context_dataset_artifact_job(
    ...
    let execution_requirement_1 = crate::execution_requirements::StoredExecutionRequirement::new(
        &payload
            .execution_requirement()
            .map_err(|failure| RepositoryError::InvalidInput(failure.to_string()))?,
    )?;
