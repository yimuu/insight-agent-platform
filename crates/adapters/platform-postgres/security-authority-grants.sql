...
-- The caller must pass a pre-created dedicated role using psql variable
-- `security_authority_role`. LOGIN credentials or group membership remain an installation concern.
...
BEGIN
    ...
    EXECUTE pg_catalog.format(
        'GRANT SELECT ON insight_platform.secret_bindings, insight_platform.principals, insight_platform.tenant_principals, insight_platform.receipts TO %I',
        target_role
    );
