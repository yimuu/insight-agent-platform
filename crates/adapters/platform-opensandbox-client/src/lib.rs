...
impl OpenSandboxHttpClient {
    ...
    pub async fn readiness_probe(
        ...
        let signing_seed = insight_platform_opensandbox_executor::generate_activation_token()
            .map_err(|_| SandboxProviderError::InvalidResponse)?;
...
impl VendorResourceLimits {
    fn from_limits(limits: &insight_platform_sandbox::contracts::SandboxResourceLimitsV1) -> Self {
        Self(BTreeMap::from([
