...
mod tests {
    ...
    fn sandbox_runtime_manifest() -> serde_json::Value {
        let document = ResourceDocument::SandboxRuntime(SandboxRuntimeResourceSpec {
            ...
            runtime_contract: SandboxRuntimeContractV1 {
                ...
                opensandbox_server_release_digest: digest('4'),
                lifecycle_schema_digest: digest('5'),
                batchsandbox_crd_digest: digest('6'),
                batchsandbox_controller_digest: digest('7'),
                kubernetes_provider_template_digest: digest('8'),
                runner_protocol_digest: digest('9'),
                container_runtime_digest: digest('a'),
                network_policy_digest: digest('b'),
            },
            fixed_runner_argv: vec!["/opt/insight/bin/platform-sandbox-runner".to_owned()],
    ...
    fn every_apply_resource_closure_resolves_only_its_published_self_versions() {
        ...
        let resolved = ApplyDeploymentClosure::SandboxProfile(ApplySandboxDeploymentBindings {
            ...
            provider_binding_digest: digest('c'),
