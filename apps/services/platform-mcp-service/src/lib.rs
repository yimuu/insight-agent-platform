...
use insight_platform_mcp_runtime::McpDiscoveryWorker;
...
use insight_platform_mcp_host::{
    ...
    McpDiscoveryWorkerError, McpJobPayload, McpWorkerAudit, RecoverExpiredMcpDiscoveryJob,
};
...
impl McpDiscoveryDriver {
    ...
    pub async fn drive_once(
        ...
        let identities = claims
            ...
            .collect::<Result<Vec<_>, McpDiscoveryDriverError>>()?;
