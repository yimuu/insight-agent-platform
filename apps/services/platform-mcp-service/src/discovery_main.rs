...
use insight_platform_mcp_runtime::{McpDiscoveryService, McpDiscoveryWorker};
use insight_platform_mcp_transport::StreamableHttpMcpDiscoveryTransport;
...
use insight_platform_mcp_host::{McpDiscoveryArtifactStageError, McpDiscoveryArtifactStager};
...
mod tests {
    ...
    fn fixture_manifest() -> insight_platform_contracts::WorkerManifest {
        insight_platform_contracts::WorkerManifest {
            ...
            worker_role: "mcp-discovery-worker".to_owned(),
