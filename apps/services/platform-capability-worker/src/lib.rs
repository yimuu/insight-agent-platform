...
use insight_platform_capability_adapters::{
    ...
    CapabilityAdapterWorker, EncodedGrpcCapabilityRequest, EncodedHttpCapabilityRequest,
    GrpcCapabilityCodec, GrpcTransportResponse, HttpCapabilityCodec, HttpTransportResponse,
...
use insight_platform_contracts::{
    builtin_echo_module_digest, builtin_json_codec_module_digest,
    builtin_json_grpc_error_mapping_digest, builtin_json_grpc_protobuf_contract_digest,
    builtin_json_grpc_request_mapping_digest, builtin_json_grpc_response_mapping_digest,
    builtin_json_http_error_mapping_digest, builtin_json_http_protocol_contract_digest,
    builtin_json_http_request_mapping_digest, builtin_json_http_response_mapping_digest,
    builtin_json_mcp_output_mapping_digest, BUILTIN_ECHO_ADAPTER_ID, BUILTIN_ECHO_ADAPTER_VERSION,
    BUILTIN_ECHO_ENTRYPOINT_ID, BUILTIN_JSON_CODEC_ID, BUILTIN_JSON_CODEC_VERSION,
};
use insight_platform_contracts::{
...
impl HttpCapabilityCodec for BuiltinJsonHttpCapabilityCodec {
    ...
    fn encode(
        &self,
        request: &insight_platform_invocations::execution_port::CapabilityAdapterRequest,
