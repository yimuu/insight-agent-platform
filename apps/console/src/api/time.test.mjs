...
const contract = JSON.parse(await readFile(new URL('../../../../contracts/platform-v1/schemas/nominal/utc-timestamp.schema.json', import.meta.url)))

test('browser deadlines satisfy the owning UtcTimestamp contract without changing the instant', () => {
  for (const input of ['2026-09-07T00:00:00.000Z', '2026-09-07T00:00:00.001Z', '2026-09-07T00:00:00.123Z', '2024-02-29T23:59:59.999Z']) {
