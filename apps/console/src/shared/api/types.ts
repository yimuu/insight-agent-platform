...
export interface ClosedJsonSchema {
...
export interface AgentSummary {
  ...
  required_features: Array<'model' | 'context' | 'remote-capability' | 'mcp' | 'sandbox'>
...
export type TaskAction = 'submit_input' | 'approve' | 'reject' | 'cancel'
export type TaskQueryPurpose = 'respondable' | 'viewable'
...
export interface TaskForm {
  ...
  generation: number
  version: number
  response_schema: ClosedJsonSchema
...
export interface RunValueMetadata {
  schema_version: 1
  run_id: string
  value_id: string
  node_id: string | null
