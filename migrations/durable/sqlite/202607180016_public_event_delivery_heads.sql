...
DROP TABLE IF EXISTS temp.public_016_validation;
CREATE TEMP TABLE public_016_validation (
    valid INTEGER NOT NULL CHECK (valid=1)
);
INSERT INTO public_016_validation(valid)
SELECT 0
WHERE EXISTS (
    SELECT 1
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_public_receipt_causation
...
CREATE INDEX IF NOT EXISTS idx_public_delivery_heads_due
...
DELETE FROM public_016_validation;
INSERT INTO public_016_validation(valid)
SELECT 0
WHERE EXISTS (
    SELECT 1
...
DROP TABLE public_016_validation;
COMMIT;
