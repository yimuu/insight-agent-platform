...
ADD COLUMN IF NOT EXISTS artifact_reference_retention_seconds BIGINT NOT NULL DEFAULT 2592000
    CHECK (
...
ADD COLUMN IF NOT EXISTS registration_kind TEXT NOT NULL DEFAULT 'legacy'
