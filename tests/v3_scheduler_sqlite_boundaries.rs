...
const WAIT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {}
output: string
workflow:
...
const TIMER_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {}
output: string
workflow:
...
const FINALIZER_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {}
output: string
workflow:
...
const FINALIZER_SUBFLOW_PARENT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {}
output: string
workflow:
...
const PARENT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
...
const DEADLINE_PARENT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {question: string}
output: string
workflow:
...
const CHILD_V1_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {question: string}
output: string
workflow:
...
const CHILD_V2_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {question: string}
output: string
workflow:
...
const OPTIONAL_SUBFLOW_PARENT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs:
  question: string
...
const DEFAULTED_SUBFLOW_CHILD_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs:
  question: string
  note: {type: string, optional: true}
...
const FAILURE_PARENT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {question: string}
output: string
workflow:
...
const FAILURE_CHILD_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
errors:
  rejected:
    category: workflow
...
const AUTHORED_RAISE_CATCH_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
errors:
  rejected:
    category: workflow
...
const TRY_RETURN_FINALLY_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {}
output: string
workflow:
...
const CATCH_RETURN_FINALLY_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
errors:
  rejected:
    category: workflow
...
const FINALIZER_RAISE_PRECEDENCE_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
errors:
  finalizer_rejected:
    category: workflow
...
const FINALIZER_RETURN_PRECEDENCE_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {}
output: string
workflow:
