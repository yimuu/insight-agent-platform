...
const AGENT_LOOP: &str = r#"api_version: insight.agent/v1
kind: agent
inputs: {seed: string}
output: string
workflow:
...
const KEYED_MAP: &str = r#"api_version: insight.agent/v1
kind: agent
types:
  Item:
...
const ORDINAL_MAP: &str = r#"api_version: insight.agent/v1
kind: agent
types:
  Item:
    fields: {id: string, text: string}
