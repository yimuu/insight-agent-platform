...
const INVALID_RAISE_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs:
  code: string
output: string
...
const DUPLICATE_MAP_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
types:
  Item:
...
const CORRUPT_FACT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
...
const CORRUPT_WAIT_FACT_AGENT: &str = r#"api_version: insight.agent/v3
kind: agent
inputs: {}
output: string
workflow:
