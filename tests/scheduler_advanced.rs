...
fn authored_raise_is_caught_but_authored_return_skips_catch_and_runs_finally() {
    let raise_source = r#"api_version: insight.agent/v1
kind: agent
errors:
  rejected:
    category: workflow
...
"#;
    ...
    let return_source = r#"api_version: insight.agent/v1
kind: agent
inputs: {}
output: string
workflow:
...
fn catch_return_runs_finally_and_finalizer_raise_overrides_pending_return() {
    let catch_return = r#"api_version: insight.agent/v1
kind: agent
errors:
  rejected:
    category: workflow
...
"#;
    ...
    let finalizer_raise = r#"api_version: insight.agent/v1
kind: agent
errors:
  finalizer_rejected:
    category: workflow
