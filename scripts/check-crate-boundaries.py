...
ALLOWED_INTERNAL = {
    ...
    "artifact_rpc": {"contracts", "models_domain"},
    "artifact_service": {"artifact_broker", "artifact_rpc", "contracts", "models_domain", "platform_postgres"},
...
FORBIDDEN_DIRECT = {
    ...
    "artifact_service": {"axum", "reqwest", "dotenvy", "tracing-subscriber", "aws-sdk-secretsmanager"},
