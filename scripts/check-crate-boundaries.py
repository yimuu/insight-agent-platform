...
ALLOWED_INTERNAL = {
    ...
    "model_worker": {"contracts", "jobs_domain", "model_adapters", "models_domain", "platform_postgres", "platform_worker"},
...
FORBIDDEN_DIRECT = {
    ...
    "model_worker": {"axum", "sqlx", "reqwest", "dotenvy", "tracing-subscriber"},
