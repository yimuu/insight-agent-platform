...
for mutation in \
  ...
  '--set gvisor.attestor.observabilityPort=9090' \
...
failures << "Sandbox Controller/WASI/gVisor/attestor ServiceMonitors are missing" unless service_monitors.length == 4
