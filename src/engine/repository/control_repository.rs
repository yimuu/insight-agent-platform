...
pub(crate) fn event_control_frames(
    ...
    provenance
        ...
        .map(|frame| match frame {
            crate::engine::control::ControlFrame::Branch(frame) => ExecutionControlFrame::Branch {
            ...
            crate::engine::control::ControlFrame::ForkLeg(frame) => {
...
impl ReuseCompatibility {
    ...
    pub fn from_admission_contract(
        contract: &crate::engine::scheduler::ReuseAdmissionContract,
    ) -> Self {
        Self::new(
