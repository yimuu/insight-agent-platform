...
use super::common::{
    canonical_intent_hash, canonical_value, decode_execution_event_schema_version,
...
async fn authoritative_scheduler_checkpoint(
    ...
    let ledger_batch: ProjectionLedgerBatch = serde_json::from_value(encoded_ledger_batch)
        .map_err(|_| RepositoryError::invalid_data())?;
                    ...
                    repository
                        .commit_run_transition(
                            ...
                            RunTransitionCommand::terminal_failure(
                                ...
                                .unwrap(),
                                PublicEventIntent::new(PublicEventPayload::RunCancelled {
                                    failure,
                                }),
                            )
                            .unwrap(),
