...
usage() {
  cat <<'EOF'
Usage: tools/qualification/qualify-development-profile.sh --insight-bin <official-binary> (--release-root <https-url> | --release-assets <directory>) --output <report.json>
...
python3 "$workspace/tools/development/build-development-profile-performance.py" \
