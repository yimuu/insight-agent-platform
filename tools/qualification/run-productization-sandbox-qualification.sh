...
usage() {
  cat <<'EOF'
Usage: tools/qualification/run-productization-sandbox-qualification.sh --environment <path> --source-revision <sha> --output <path> [--release-candidate-closure <path>]
...
PY
"$root/tools/qualification/qualify-platform-sandbox-l3.sh"
