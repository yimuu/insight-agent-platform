...
manifest = (root / "apps/services/platform-mcp-cleanup-worker/Cargo.toml").read_text(encoding="utf-8")
source = (root / "apps/services/platform-mcp-cleanup-worker/src/main.rs").read_text(encoding="utf-8")
