...
manifest = (root / "apps/services/platform-orchestration-worker/Cargo.toml").read_text(encoding="utf-8")
source = (root / "apps/services/platform-orchestration-worker/src/main.rs").read_text(encoding="utf-8")
