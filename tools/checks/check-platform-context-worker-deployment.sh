...
source = (root / "apps/services/platform-context-worker/src/main.rs").read_text(encoding="utf-8")
remote_source = (root / "apps/services/platform-context-worker/src/remote_main.rs").read_text(encoding="utf-8")
subscription_source = (root / "apps/services/platform-context-worker/src/subscription_main.rs").read_text(encoding="utf-8")
dataset_source = (root / "apps/services/platform-context-worker/src/dataset_main.rs").read_text(encoding="utf-8")
failures = []
