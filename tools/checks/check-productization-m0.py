...
def main() -> None:
    ...
    for scenario in scenarios:
        ...
        if not isinstance(fixture, str) or not fixture.startswith("tests/qualification/tests/productization/"):
            fail(f"{scenario_id}.fixture must reserve a productization test path")
        expected_fixture = f"tests/qualification/tests/productization/{scenario_id.replace('-', '_')}.rs"
