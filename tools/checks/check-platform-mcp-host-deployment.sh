...
rpc = (root / "crates/protocols/platform-mcp-rpc/src/lib.rs").read_text(encoding="utf-8")
source = (root / "apps/services/platform-mcp-service/src/main.rs").read_text(encoding="utf-8")
resource_source = (root / "apps/services/platform-mcp-service/src/resource_main.rs").read_text(encoding="utf-8")
discovery_source = (root / "apps/services/platform-mcp-service/src/discovery_main.rs").read_text(encoding="utf-8")
subscription_source = (root / "apps/services/platform-mcp-service/src/subscription_main.rs").read_text(encoding="utf-8")
