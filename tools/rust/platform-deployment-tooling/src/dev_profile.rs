...
const REGISTRY_BYTES: &[u8] =
    include_bytes!("../../../../deploy/release/development-profile-v1.json");
const REGISTRY_SCHEMA_BYTES: &[u8] =
    include_bytes!("../../../../deploy/release/development-profile-v1.schema.json");
...
impl DevProfile {
    ...
    pub fn validate_host(self, os: &str, arch: &str) -> Result<(), String> {
