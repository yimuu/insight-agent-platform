...
WRAPPER = ROOT / "tools/qualification/run-productization-sandbox-qualification.sh"
QUALIFIER = ROOT / "tools/qualification/qualify-platform-sandbox-l3.sh"
...
class ProductizationSandboxQualificationTests(unittest.TestCase):
    ...
    def test_l3_cargo_invocations_are_locked(self) -> None:
        ...
        self.assertIn("cargo run --locked -p insight-platform-storage-tooling", source)
