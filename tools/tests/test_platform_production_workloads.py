...
SCRIPT = next(parent for parent in pathlib.Path(__file__).resolve().parents if (parent / "Cargo.toml").is_file()) / "tools/checks/check-platform-production-workloads.py"
