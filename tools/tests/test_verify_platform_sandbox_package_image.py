...
REPOSITORY_ROOT = next(parent for parent in Path(__file__).resolve().parents if (parent / "Cargo.toml").is_file())
VERIFIER = REPOSITORY_ROOT / "tools/checks/verify-platform-sandbox-package-image.py"
