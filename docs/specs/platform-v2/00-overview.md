...
| 编号 | 文件 | 状态 | 负责合同 |
|---|---|---|---|
| 00 | `00-overview.md` | Accepted / CR-190 | 总体路线、规范模板、依赖和完成定义 |
...
| 07 | [`07-scheduler-workers-and-concurrency.md`](07-scheduler-workers-and-concurrency.md) | Accepted / CR-190 | Scheduler、Worker、Lease、背压和隔舱并发 |
...
| 12 | [`12-context-and-retrieval.md`](12-context-and-retrieval.md) | Accepted / CR-190 | ContextSource、检索、引用和数据权限 |
| 13 | [`13-mcp-host.md`](13-mcp-host.md) | Accepted / CR-190 | MCP Transport、OAuth、投影、Task 和 Subscription |
...
| 18 | [`18-deployment-observability-and-qualification.md`](18-deployment-observability-and-qualification.md) | Accepted / CR-190 | Kubernetes、指标、Tracing、压测、故障注入和验收 |
