...
| 属性 | 值 |
|---|---|
| 状态 | In Progress / CR-216 revision 5 |
| 日期 | 2026-09-02 |
...
| 14 | [`14-sandbox-execution-plane.md`](14-sandbox-execution-plane.md) | Accepted / CR-216 revision 5 | OpenSandbox Kubernetes、Armed runner activation、执行、point-read orphan decision和清理 |
