...
| 10 | [`10-capability-invocation.md`](10-capability-invocation.md) | Accepted / CR-182 | 调用协议、幂等、同步快路径、异步恢复 |
| 11 | [`11-skill-system.md`](11-skill-system.md) | Accepted / CR-182 | Skill Package、发现、选择、绑定和依赖 |
...
| 16 | [`16-model-provider-and-invocation.md`](16-model-provider-and-invocation.md) | Accepted / CR-182 | Provider、Model Profile、ModelTurn、流式响应和预算 |
| 17 | [`17-management-and-runtime-api.md`](17-management-and-runtime-api.md) | Accepted / CR-181 | 管理 API、Run API、事件流和错误模型 |
| 18 | [`18-deployment-observability-and-qualification.md`](18-deployment-observability-and-qualification.md) | Accepted / CR-182 | Kubernetes、指标、Tracing、压测、故障注入和验收 |
...
timeout的typed Job scheduling与critical-control bounded scan已通过fresh PostgreSQL 16 r88 L2 fixture；独立认证Signal ingress与上述
leaf的多进程kill/recovery仍属L3未完成项，ModelLoop、CapabilityCall和ContextQuery owner dispatch也尚未接线，因此不能据此宣称
Phase 2完成。
