...
> rollout漂移在claim/stage前fail closed。
...
> CR-181/203 impact：Plan v5 input/route/result为Artifact-backed ValueRef时仍走Artifact Data Worker的brokered exact RunValue read/write；
