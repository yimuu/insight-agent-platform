...
> Historical pre-v2 status. DSL and scheduler sections describe the retired graph runtime; the then-current authored contract was [DSL Authoring Surface Redesign](../specs/2026-07-17-dsl-authoring-surface-redesign.md), lowered to the Region/SSA runtime described by the historical README and vNext design.
